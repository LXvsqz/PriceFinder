...
public class NoApplet extends JPanel {
    ...
    /** Overridden here to prevent a subclass from overriding
     * this method. A subclass should override the
     * <code>paintComponent(Graphics)</code> method instead of
     * this method.
     */
    @Override
    ...
    /** Resize this NoApplet. This method must be called in constructors
     * to have effect. */
